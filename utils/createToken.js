...
const createResetPasswordToken = (payload) => {
    return jwt.sign(payload, process.env.JWT_RESET_PASSWORD_REFRESH_TOKEN_SECRET, { expiresIn: '15m' });
};
...
module.exports = { createResetPasswordToken, createAccessToken, createRefreshToken };